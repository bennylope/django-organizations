    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "organization",
                    models.OneToOneField(related_name="owner", to="accounts.Account"),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "organization",
                    models.ForeignKey(
                        related_name="organization_users", to="accounts.Account"
                    ),
                ),
                (
                    "user",
                    models.ForeignKey(
                        related_name="accounts_accountuser", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
        ...
        migrations.AlterUniqueTogether(
            name="accountuser", unique_together=set([("user", "organization")])
        ),
    ]
