    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invitee', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='test_vendors_vendorinvitation_invitations', to=settings.AUTH_USER_MODEL)),
